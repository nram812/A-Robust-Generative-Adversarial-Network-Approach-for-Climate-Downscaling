...
with strategy.scope():
    ...
    data = tuple([tf.convert_to_tensor(y.tasmin[:eval_times].transpose("time", "lat", "lon").values, 'float32'),
    ...
    wgan.fit(data, batch_size=BATCH_SIZE, epochs=config["epochs"], verbose=1, shuffle=False,
